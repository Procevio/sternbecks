...
|---------|-----------------|-----------------|
| **Dörrpartier** | 5 000 kr | Renovering av dörrparti |
| **Källare/Glugg** | 3 500 kr | Källarfönster och gluggar |
| **1 luftare** | 4 000 kr | Fönster med 1 luftare |
| **2 luftare** | 5 500 kr | Fönster med 2 luftare |
| **3 luftare** | 8 250 kr | Fönster med 3 luftare |
| **4 luftare** | 11 000 kr | Fönster med 4 luftare |
| **5 luftare** | 13 750 kr | Fönster med 5 luftare |
| **6 luftare** | 16 500 kr | Fönster med 6 luftare |
...
| **Isolerglas** | -400 kr | -400kr × totalt antal luftare |
| **Kopplade isolerglas** | +500 kr | +500kr × totalt antal luftare |
| **Insatsbågar yttre** | -400 kr | -400kr × totalt antal luftare |
| **Insatsbågar inre** | -1 250 kr | -1250kr × totalt antal luftare |
| **Insatsbågar komplett** | +1 000 kr | +1000kr × totalt antal luftare |

**Luftare-beräkning:**
```
Totalt antal luftare = (antal 1-luftare × 1) + (antal 2-luftare × 2) + (antal 3-luftare × 3) + osv
```
